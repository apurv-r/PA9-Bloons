...
//
//void Game::handleMouseClick(void)
//{
//	runThroughTowers();
//	ui.checkForMenuOpenClose(*m_Window);
//	switch (ui.checkForTowerPlacement(*m_Window))
//	{
//	case 1:
//		std::cout << "spawn Tower" << std::endl;
//		subtractMoney(50);
//		spawnTower(sf::Vector2f(sf::Mouse::getPosition()));
//	}
//}
//
//void Game::HandleMouseRelease(void)
//{
//	ui.getTowerPlacement();
//
//}